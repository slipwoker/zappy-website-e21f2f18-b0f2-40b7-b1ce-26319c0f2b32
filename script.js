    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "א.ש מיזוג אוויר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e21f2f18-b0f2-40b7-b1ce-26319c0f2b32',
                    name: data.name || '',
                    email: data.email || '',
